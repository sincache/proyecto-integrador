        ...
        <div className="footer-container">
          <div className="newsletter-section">
            ...
            <form className="newsletter-form">
              ...
              <button type="submit" className='Button-footer'>Suscribirse</button>
            </form>
          ...
          <div className="footer-links">
            <div className="footer-column">
              ...
              <a href="#">Sobre TechWomen Academy</a>
            ...
            <div className="footer-column">
              <h6>Cursos y talleres</h6>
              <a href="#">Cursos gratis</a>
              <a href="#">Talleres</a>
              <a href="#">Talleres para empresas</a>
              <a href="#">Certificación de cursos</a>
              <a href="#">Precios</a>
            </div>
              ...
              <div className="social-links">
                <div className="icon-list">
                  <a href="https://www.facebook.com/" >
                    ...
                    <span className='NameIcon'>Facebook</span> 
                  </a>
                  <a href="https://www.instagram.com/">
                    ...
                    <span className='NameIcon'>Instagram</span>
                  </a>
                  <a href="https://www.twitter.com/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
                      <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" />
                    </svg>
                    <span className='NameIcon'>X</span>
                  </a>
                  ...
                  <a href="https://www.linkedin.com/">
                    ...
                    <span className='NameIcon'>LinkedIn</span>
                  </a>
                  <a href="https://www.youtube.com/">
                    ...
                    <span className='NameIcon'>YouTube</span>
                  </a>
                </div>
              </div>
            </div>
