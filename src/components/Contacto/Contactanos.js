          ...
          <div class="navbar-container">
              ...
              <div class="navbar-right">
                  <div class="navbar-links">
                      ...
                      <a class="nav-link" href="#">Cursos/Talleres</a>
                      <a class="nav-link" href="#">Más Opciones</a>
                  </div>

                  <div class="navbar-buttons">
                      <button class="btn btn-unirse">Unirse</button>
                      <button class="btn btn-iniciar">Iniciar</button>
                  </div>
              </div>
          </div>
      </nav>
              ...
              <div class="row w-75 shadow-lg rounded overflow-hidden">
                  ...
                  <div class="col-md-5 bg-dark text-white p-5 d-flex flex-column justify-content-center">
                      ...
                      <div class="data text-center">
                          ...
                          <p><i class="fas fa-envelope"></i> sincahe@mail.com </p>
                  ...
                  <div class="col-md-7 bg-purple-light p-5 d-flex flex-column justify-content-center">
                      ...
                      <form id="contactForm">
                          ...
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="nombre" placeholder="Escribe tu nombre completo"
                                  required>
                          </div>
                          ...
                          {/* Botón de Enviar */}
                          <button type="submit" class="btn btn-accent mt-3" id="submit">Enviar Mensaje</button>
                      </form>
                  </div>
              </div>
          </div>
      ...
      <footer>
          <div class="container">
              ...
              <div class="footer-bottom mt-4">
                  <p>© 2024 TechWomen Academy. Todos los derechos reservados.</p>
